...
class TestRDopImport(TestCase):
    pid = os.getpid()
    rm_vec = []
    aoi_map_file = os.path.join("data", "test_aoi_SN.gpkg")
    ...
    def test_extent_aoi_map(self):
        ...
        self.assertTrue(
            int(cells_aoi) == 2021300, "Data loaded for larger region than AOI"
        )
        print("Test AOI (Sachsen) successfully finished.\n")
    ...
    def test_dop_resolution(self):
        ...
        print("Test resolution (SN) successfully finished.\n")
