...
# %Module
# % description: Downloads and imports single Digital Orthophotos (DOPs) in Schleswig-Holstein
# % keyword: imagery
# % keyword: download
# % keyword: DOP
# %end
...
def main():
    """Main function of r.dop.import.worker.sh"""
    ...
    new_rm_rast = rescale_to_1_255("SH", raster_name)
