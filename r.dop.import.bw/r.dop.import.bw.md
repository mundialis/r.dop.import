...
*r.dop.import.bw* downloads and imports [digital orthophotos (DOP)](https://www.lgl-bw.de/Produkte/Open-Data/) for Baden-Württemberg (BW) and area of interest using the respective [WMS](https://metadaten.geoportal-bw.de/geonetwork/srv/ger/catalog.search#/metadata/63985d3a-2be1-25bd-4cf8-ed84a1c7f7b1)
and [WMS](https://metadaten.geoportal-bw.de/geonetwork/srv/ger/catalog.search#/metadata/4927a198-e9ce-da9a-a5ef-c11f21ff173f).
