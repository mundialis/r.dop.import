...
*r.dop.import.ni* downloads and imports [digital orthophotos (DOP)](https://ni-lgln-opengeodata.hub.arcgis.com/apps/lgln-opengeodata::digitales-orthophoto-dop/about) for Niedersachsen (NI) and area of interest.
