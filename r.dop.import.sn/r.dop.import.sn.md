...
*r.dop.import.sn* downloads and imports [digital orthophotos (DOP)](https://www.geodaten.sachsen.de/batch-download-4719.html) for Sachsen (SN) and area of interest.
