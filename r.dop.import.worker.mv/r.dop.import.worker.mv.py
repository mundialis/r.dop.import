...
# %Module
# % description: Downloads and imports single Digital Orthophotos (DOPs) in Mecklenburg-Vorpommern
# % keyword: imagery
# % keyword: download
# % keyword: DOP
# %end
...
def main():
    """Main function of r.dop.import.worker.mv"""
    ...
    new_rm_rast = rescale_to_1_255("MV", raster_name)
