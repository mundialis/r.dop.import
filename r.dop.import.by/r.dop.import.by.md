...
(DOP)](https://geodaten.bayern.de/opengeodata/) for Bayern (BY) and area
of interest using the respective
[WMS](https://geodaten.bayern.de/opengeodata/OpenDataDetail.html?pn=dop20rgb&active=SERVICE).  
