...
*r.dop.import.nw* downloads and imports [digital orthophotos (DOP)](https://www.opengeodata.nrw.de/produkte/geobasis/lusat/akt/dop/dop_jp2_f10/) for Nordrhein-Westfalen (NW) and area of interest.
