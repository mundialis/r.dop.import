...
############################################################################
#
# MODULE:      r.dop.import.rp
# AUTHOR(S):   Victoria-Leandra Brunn, Johannes Halbauer, Anika Weinmann
# PURPOSE:     Downloads DOPs for Rhineland-Palatine and AOI
...
# %module
# % description: Downloads DOPs for Rhineland-Palatine and AOI.
# % keyword: raster
# % keyword: import
# % keyword: DOP
...
def main():
    """Main function of r.dop.import.rp"""
    aoi = options["aoi"]
    ...
    try:
        ...
        for tile in url_tiles:
            ...
            r_dop_import_worker_rp.stdout_ = grass.PIPE
            r_dop_import_worker_rp.stderr_ = grass.PIPE
            queue.put(r_dop_import_worker_rp)
        queue.wait()
    except Exception:
