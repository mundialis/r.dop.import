...
*r.dop.import* downloads digital orthophotos (DOPs) for specified
federal state and area of interest, stores it in a local directory and
creates a single file of DOPs in GRASS. Implemented federal state
options are:
